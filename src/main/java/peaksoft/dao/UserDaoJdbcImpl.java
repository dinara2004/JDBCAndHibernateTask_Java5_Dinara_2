...
public class UserDaoJdbcImpl implements UserDao {
    ...
    public void dropUsersTable() {
        ...
        try (Statement statement = connection.createStatement()) {
            ...
            System.out.println("You've successfully dropped to table 'users'! ");
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    }
    ...
    public void removeUserById(long id) {
        ...
        try(PreparedStatement preparedStatement = connection.prepareStatement(query)) {
            ...
            System.out.println("You've successfully deleted the user by ID! ");
            preparedStatement.execute();
        } catch (SQLException e) {
            throw new RuntimeException(e);
        }
    ...
    public List<User> getAllUsers() {
        ...
        try (Statement statement = connection.createStatement()) {
            ...
            while (resultSet.next()) {
                User user = new User();
//                System.out.println("You've successfully get all users! ");
    ...
    public void cleanUsersTable() {
        ...
        try(Statement statement = connection.createStatement()) {
            statement.execute(query);
            System.out.println("You've successfully clean the table! ");
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }
